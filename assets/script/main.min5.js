...
if (document.getElementById('gallery-spotlight')) {
	_gallery_ = new Vue({
		el: '#gallery-spotlight',

		mixins: [animation_mixin],

		computed: {
			_gallery_items: function () {
		...
		methods: {
			show_gallery: function (item) {
				console.log(item)
				var instance = jQuery.fancybox
				instance.open(strip(item), {
					helpers: {
						thumbs: {
							width: 75,
							height: 50,
