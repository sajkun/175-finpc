      ...
      <ul class="menu-socials yellow">
       ...
       ?>
         <li class="<?php echo $icon; ?>"><a href="<?php echo $url; ?>">
               <svg class="icon svg-icon-<?php echo $icon; ?>">
                  <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-icon-<?php echo $icon; ?>"></use>
               </svg>
            </a></li>
         <?php endforeach ?>
      </ul>
         ...
         <div class="row">
            <div class="col-sm-7 col-md-11 col-lg-10 col-xl-8">
               <ul class="address-data bg-white">
                  ...
                  <li>
                     <i class="icon">
                        <svg class="svg-icon-geo">
                           <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-icon-geo"></use>
                        </svg>
                     </i>
                  ...
                  <li>
                     <i class="icon">
                        <svg class="svg-icon-mail">
                           <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-icon-mail"></use>
                        </svg>
                     </i>
                     <a href="mailto:<?php echo $welcome['email'] ?>"
                        class="address-data__item"><?php echo $welcome['email'] ?></a>
                  </li>
                  <?php endif ?>
                 ...
                 ?>
                  <li>
                     ...
                     <a href="tel:<?php echo preg_replace('/\W/', '', $p); ?>"
                        class="address-data__item"><?php echo $p; ?></a>
                     <?php endforeach ?>
                  </li>
                  <?php endif ?>
               </ul>
      ...
      <div class="articles-body">
         ...
         <div class="articles-carousel owl-carousel">
            ...
            <div class="article-carousel__item">
               ...
               <a href="<?php echo $item['url'] ?>" onclick="play_video('<?php echo $item['url'] ?>', event)"
                  class="article-carousel__item-title"><?php echo $item['title'] ?></a>
